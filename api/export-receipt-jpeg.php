...
try {
    ...
    // // Receipts don't have line items in the same way
    ...
    imagettftext($image, 28, 0, $margin + 300, $y, $black, $fontPath, date('d/m/Y', strtotime($receipt['receipt_date'])));
    $y += 60;
    ...
    imagettftext($image, 28, 0, $margin + 300, $y, $black, $fontPath, $receipt['salesperson']);

    $y = $boxY + 280;

    // Document title
    imagettftext($image, 36, 0, $margin, $y, $black, $fontBoldPath, 'Project: ' . substr($receipt['receipt_title'], 0, 50));
    $y += 100;
    ...
    imagettftext($image, 28, 0, $width - $margin - 380, $y, $black, $fontBoldPath, formatNaira($receipt['subtotal']));
    $y += 70;

    // VAT
    imagettftext($image, 28, 0, $width - $margin - 750, $y, $gray, $fontPath, 'VAT (7.5%):');
    imagettftext($image, 28, 0, $width - $margin - 380, $y, $black, $fontBoldPath, formatNaira($receipt['total_vat']));
    $y += 90;
    ...
    imagettftext($image, 38, 0, $width - $margin - 380, $y, $blue, $fontBoldPath, formatNaira($receipt['grand_total']));
