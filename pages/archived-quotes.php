...
<div class="bg-white rounded-lg shadow-md p-8">
    <div class="flex items-center justify-between mb-6">
        <div>
            <h2 class="text-3xl font-bold text-gray-900">Archived Quotes</h2>
            <p class="text-sm text-gray-600 mt-1">Archived quotes can be restored or permanently deleted</p>
        </div>
        <a href="view-quotes.php" class="px-4 py-2 text-primary hover:bg-blue-50 rounded-lg font-semibold">
    ...
    <?php if (empty($quotes)): ?>
        <div class="text-center py-12">
            ...
            <h3 class="text-xl font-semibold text-gray-700 mb-2">No archived quotes</h3>
    ...
    <?php else: ?>
        ...
        <div class="mt-6 text-sm text-gray-600">
            <p>Total Archived Quotes: <strong>
    ...
    <div id="permanentDeleteModal"
        ...
        <div class="bg-white rounded-lg shadow-xl p-8 max-w-md w-full mx-4">
            ...
            <p class="text-gray-700 mb-4">You are about to <strong class="text-red-600">PERMANENTLY DELETE</strong> <strong
                    id="permanentDeleteCount">0</strong> quote(s). This action <strong>CANNOT BE UNDONE</strong>.</p>
