...
$pageTitle = 'Generate Receipt - Bluedots Technologies';

include '../includes/header.php';
?>

<div class="bg-white rounded-lg shadow-md p-8 max-w-3xl mx-auto">
    <h2 class="text-3xl font-bold text-gray-900 mb-6">Generate Receipt</h2>
    ...
    <form method="POST" action="../api/generate-receipt.php">
        ...
        <div class="flex gap-4 justify-end">
            ...
            <button type="submit"
                class="px-6 py-3 bg-purple-600 text-white rounded-lg hover:bg-purple-700 font-semibold flex items-center gap-2">
