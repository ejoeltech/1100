...
<div class="flex flex-wrap gap-4 mb-6 no-print">
    ...
    <div class="relative group">
        ...
        <div class="hidden group-hover:block absolute top-full left-0 mt-1 bg-white shadow-lg rounded-lg py-2 min-w-[180px] z-50">
            <a href="../api/export-receipt-pdf.php?id=<?php echo $receipt['id']; ?>" 
               target="_blank"
            ...
            <a href="../api/export-receipt-jpeg.php?id=<?php echo $receipt['id']; ?>" 
               target="_blank"
               class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 flex items-center gap-2">
            ...
            <a href="../api/export-receipt-html.php?id=<?php echo $receipt['id']; ?>" 
               target="_blank"
               class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 flex items-center gap-2">
...
<!-- Receipt Display -->
<div id="printableReceipt" class="bg-white rounded-lg shadow-md p-12 max-w-4xl mx-auto">
    <!-- Header -->
